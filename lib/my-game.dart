...
class MyGame extends Game {
  ...
  void afegirDades() {
    ...
    elements["graf"] = graf;
    MyElement abracada = MyElement(this, "abraçada", "Abraçada", "Per què no m’estàs abraçant?");
    elements["abraçada"] = abracada;
    ...
    MyElement perrofla = MyElement(this, "perrofla", "Perrofla", "Riño y rastas");
    ...
    MyElement javilopezcontreras = MyElement(this, "javilopezcontreras", "Javi", "Super creador d’aquest joc");
    ...
    MyElement mariaprat = MyElement(this, "mariaprat", "Maria Prat", "Super creadora d’aquest joc ");
    ...
    MyElement pibuti = MyElement(this, "pibuti", "Pi-buti", "Ara vendrem hamburgueses, que es la setmana de la dona");
    ...
    MyElement ambulancia = MyElement(this, "ambulancia", "Ambulància", "Ni nu ni nu ni nu ni nu");
    ...
    elements["team"] = team;
    MyElement llops = MyElement(this, "llops", "Llops", "Pico pico pico picoooo");
    elements["llops"] = llops;
    MyElement trivial = MyElement(this, "trivial", "Trivial", "Quan encara existia...");
    elements["trivial"] = trivial;
    MyElement assamblea = MyElement(this, "assamblea", "Assamblea", "Assamblea");
    elements["assamblea"] = assamblea;
    MyElement baixet = MyElement(this, "baixet", "Baixet", "Lo que no es alto");
    elements["baixet"] = baixet;
    MyElement danivilardell = MyElement(this, "danivilardell", "Dani Vilardell", "Dani Vilardell");
    elements["danivilardell"] = danivilardell;
    recipes["alcohol-fme"] = Recipe(this, "birres1", alcohol, fme, alcohol);
    ...
    recipes["cuqui-rafahhajjar"] = Recipe(this, "abraçada1", cuqui, rafahhajjar, abracada);
    ...
    recipes["laura-lavabocfis"] = Recipe(this, "picatrencada2", lauraarribas, lavabocfis, picatrencada);
    ...
    recipes["secta-volum"] = Recipe(this, "martina1", secta, volum, martinacolas);
    ...
    recipes["fme-perrofla"] = Recipe(this, "assemblea1", fme, perrofla, assamblea);
    recipes["assamblea-novatos"] = Recipe(this, "conjuntbuit3", assamblea, novatos, conjuntbuit);
